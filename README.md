...
```php
use bahetihawa\Searchable\SearchableTrait;
...
[![Support via Gittip](https://rawgithub.com/twolfson/gittip-badge/0.2.0/dist/gittip.png)](https://gratipay.com/bahetihawa/)
